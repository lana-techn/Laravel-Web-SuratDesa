<div class="p-10 w-full">
    <h1 class="text-center text-4xl font-semibold text-white">Daftar Penduduk</h1>
    <form action="/resident" method="POST" class="w-full p-10 mt-5 rounded-md bg-slate-100">
        @csrf
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div>
                <label for="father_birthday" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal
                    Lahir Ayah</label>
                <input type="date" id="father_birthday"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    name="father_birthday" required />
            </div>
            <div>
                <label for="father_job" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pekerjaan
                    Ayah</label>
                <input type="text" id="father_job"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    name="father_job" required />
            </div>
            ...
            <div>
                ...
                <input type="text" id="status_in_family"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    name="status_in_family" required />
            </div>
        </div>
        <button type="submit"
